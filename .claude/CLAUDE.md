...
Last indexed: 2026-07-19 (commit 843e78c). Confidence: 100%.
### Entry Points
- `ai-sidecar/main.py`
...
|------|-------|-------------|-------|
| `frontend/src/locales/ar.json` | 100.0th %ile | 9 | HaMzWe |
| `frontend/src/locales/en.json` | 99.7th %ile | 9 | HaMzWe |
