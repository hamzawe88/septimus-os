...
Last indexed: 2026-07-20 (commit aa51343). Confidence: 100%.
### Entry Points
- `ai-sidecar/main.py`
...
|------|-------|-------------|-------|
| `frontend/src/locales/ar.json` | 100.0th %ile | 10 | HaMzWe |
| `frontend/src/locales/en.json` | 99.7th %ile | 10 | HaMzWe |
| `frontend/src/components/settings/AISettings.tsx` | 99.5th %ile | 4 | HaMzWe |
| `ai-sidecar/main.py` | 99.2th %ile | 7 | HaMzWe |
| `frontend/src/components/layout/TopBar.tsx` | 99.0th %ile | 5 | HaMzWe |
...
Defect risk, Hotspot health: 7.32/10 (stable) ·
Average: 8.14/10 ·
...
- `backend-core/services/embeddings.go` — untested hotspot — impact −2.0
- `frontend/src/locales/ar.json` — hidden coupling — impact −2.0
- `frontend/src/locales/en.json` — hidden coupling — impact −2.0
