      ...
      <div className="bg-card w-full max-w-md rounded-2xl shadow-xl border border-border flex flex-col overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-border flex items-center justify-between">
          ...
          <button
            ...
            className="p-2 text-muted-foreground hover:text-[var(--sb-bg)]/80 :text-slate-300 rounded-full transition-colors"
          >
            <X size={20} />
          </button>
        </div>
        ...
        <div className="p-6 flex flex-col items-center">
          <div className="w-full flex items-center justify-center w-full">
            <label
              ...
              className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed rounded-xl cursor-pointer bg-card :bg-background hover:bg-muted border-border transition-colors"
            >
